...
void win1()
{
    ...
    outtextxy(150,150,"player 2 win");
    getch();
    exit(1);
}
...
int main()
{
    ...
    while(1)
    {
        ...
        setcolor(BLUE);
        if(rectPosX2 >a+30&& rectPosX<b-30)
        {
        ...
        for(int i=0; i<380; i+=200)
        {
            ...
            if((rectPosX2)==(i+e_y3)||(rectPosX2)==(-100+i+e_y3+30)||(rectPosX2)==(10+i+e_y3+30))
                win1();
        ...
        for(int i=0; i<380; i+=200)
        {
            ...
            if((rectPosX2+150)==(i+e_y4)||(rectPosX2+150)==(-100+i+e_y4+30)||(rectPosX2+150)==(10+i+e_y4+30))
                win1();
        ...
        for(int i=0; i<380; i+=200)
        {
            ...
            if((rectPosX2+200)==(50+i+e_y1)||(rectPosX2+200)==(50+i+e_y1+30)||(rectPosX2+200)==(50+i+e_y1+30))
                win1();
